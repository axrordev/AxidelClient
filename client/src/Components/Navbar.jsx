										...
										<div className="relative" ref={dropdownRef}>
											...
											>
												...
												<ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
													...
													<li>
														<Link to="/mycollection" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
															My Collections
														</Link>
													</li>
													<li>
														<Link to="/services" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
															Services
														</Link>
													</li>
												</ul>
